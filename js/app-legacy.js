...
var firebase = new _services_FirebaseDBService__WEBPACK_IMPORTED_MODULE_9__.FirebaseDBService();
var appStateModule = {
  state: {
    cars: null,
    user: null,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                userService = new _services_UserService__WEBPACK_IMPORTED_MODULE_10__.UserService();
                _context.next = 9;
