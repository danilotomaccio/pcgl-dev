 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ce{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){const e=new G;if(this.instancesDeferred.set(t,e),this.isInitialized(t)||this.shouldAutoInitialize())try{const n=this.getOrInitializeService({instanceIdentifier:t});n&&e.resolve(n)}catch(n){}}return this.instancesDeferred.get(t).promise}getImmediate(e){var t;const n=this.normalizeInstanceIdentifier(null===e||void 0===e?void 0:e.identifier),r=null!==(t=null===e||void 0===e?void 0:e.optional)&&void 0!==t&&t;if(!this.isInitialized(n)&&!this.shouldAutoInitialize()){if(r)return null;throw Error(`Service ${this.name} is not available`)}try{return this.getOrInitializeService({instanceIdentifier:n})}catch(i){if(r)return null;throw i}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,this.shouldAutoInitialize()){if(ue(e))try{this.getOrInitializeService({instanceIdentifier:oe})}catch(t){}for(const[e,n]of this.instancesDeferred.entries()){const r=this.normalizeInstanceIdentifier(e);try{const e=this.getOrInitializeService({instanceIdentifier:r});n.resolve(e)}catch(t){}}}}clearInstance(e=oe){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter((e=>"INTERNAL"in e)).map((e=>e.INTERNAL.delete())),...e.filter((e=>"_delete"in e)).map((e=>e._delete()))])}isComponentSet(){return null!=this.component}isInitialized(e=oe){return this.instances.has(e)}getOptions(e=oe){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:t={}}=e,n=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(n))throw Error(`${this.name}(${n}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const r=this.getOrInitializeService({instanceIdentifier:n,options:t});for(const[i,s]of this.instancesDeferred.entries()){const e=this.normalizeInstanceIdentifier(i);n===e&&s.resolve(r)}return r}onInit(e,t){var n;const r=this.normalizeInstanceIdentifier(t),i=null!==(n=this.onInitCallbacks.get(r))&&void 0!==n?n:new Set;i.add(e),this.onInitCallbacks.set(r,i);const s=this.instances.get(r);return s&&e(s,r),()=>{i.delete(e)}}invokeOnInitCallbacks(e,t){const n=this.onInitCallbacks.get(t);if(n)for(const i of n)try{i(e,t)}catch(r){}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let n=this.instances.get(e);if(!n&&this.component&&(n=this.component.instanceFactory(this.container,{instanceIdentifier:le(e),options:t}),this.instances.set(e,n),this.instancesOptions.set(e,t),this.invokeOnInitCallbacks(n,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,n)}catch(r){}return n||null}normalizeInstanceIdentifier(e=oe){return this.component?this.component.multipleInstances?e:oe:e}shouldAutoInitialize(){return!!this.component&&"EXPLICIT"!==this.component.instantiationMode}}function le(e){return e===oe?void 0:e}function ue(e){return"EAGER"===e.instantiationMode}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const ct="firebase-heartbeat-database",lt=1,ut="firebase-heartbeat-store";let ht=null;function ft(){return ht||(ht=(0,be.openDb)(ct,lt,(e=>{switch(e.oldVersion){case 0:e.createObjectStore(ut)}})).catch((e=>{throw rt.create("storage-open",{originalErrorMessage:e.message})}))),ht}async function dt(e){try{const t=await ft();return t.transaction(ut).objectStore(ut).get(mt(e))}catch(t){throw rt.create("storage-get",{originalErrorMessage:t.message})}}async function pt(e,t){try{const n=await ft(),r=n.transaction(ut,"readwrite"),i=r.objectStore(ut);return await i.put(t,mt(e)),r.complete}catch(n){throw rt.create("storage-set",{originalErrorMessage:n.message})}}async function gt(e){try{const t=await ft(),n=t.transaction(ut,"readwrite");return await n.objectStore(ut).delete(mt(e)),n.complete}catch(t){throw rt.create("storage-delete",{originalErrorMessage:t.message})}}function mt(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ln="firebase-installations-database",un=1,hn="firebase-installations-store";let fn=null;function dn(){return fn||(fn=(0,be.openDb)(ln,un,(e=>{switch(e.oldVersion){case 0:e.createObjectStore(hn)}}))),fn}async function pn(e,t){const n=en(e),r=await dn(),i=r.transaction(hn,"readwrite"),s=i.objectStore(hn),a=await s.get(n);return await s.put(t,n),await i.complete,a&&a.fid===t.fid||nn(e,t.fid),t}async function gn(e){const t=en(e),n=await dn(),r=n.transaction(hn,"readwrite");await r.objectStore(hn).delete(t),await r.complete}async function mn(e,t){const n=en(e),r=await dn(),i=r.transaction(hn,"readwrite"),s=i.objectStore(hn),a=await s.get(n),o=t(a);return void 0===o?await s.delete(n):await s.put(o,n),await i.complete,!o||a&&a.fid===o.fid||nn(e,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lr="firebase-messaging-database",ur=1,hr="firebase-messaging-store";let fr=null;function dr(){return fr||(fr=(0,be.openDb)(lr,ur,(e=>{switch(e.oldVersion){case 0:e.createObjectStore(hr)}}))),fr}async function pr(e){const t=wr(e),n=await dr(),r=await n.transaction(hr).objectStore(hr).get(t);if(r)return r;{const t=await or(e.appConfig.senderId);if(t)return await gr(e,t),t}}async function gr(e,t){const n=wr(e),r=await dr(),i=r.transaction(hr,"readwrite");return await i.objectStore(hr).put(t,n),await i.complete,t}async function mr(e){const t=wr(e),n=await dr(),r=n.transaction(hr,"readwrite");await r.objectStore(hr).delete(t),await r.complete}function wr({appConfig:e}){return e.appId}
/**
 * @license
 * Copyright 2017 Google LLC
 *
